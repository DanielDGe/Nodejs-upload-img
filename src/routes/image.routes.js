...
//Estableciendo el nombre de la image y su ruta de almacenamiento
...
//Agregando un limite para el tamaño o peso de la imagen
...
router.get('/images', (req, res) => { res.send('/images route')});
